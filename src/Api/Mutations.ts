...
import type { AddAdditionalChargesPayload, AddAnnouncementPayload, AddBankPayload, AddBankTransactionPayload, AddBillOfLiveProductPayload, AddBranchPayload, AddBrandPayload, AddCallRequestPayload, AddCategoryPayload, AddCompanyPayload, AddConsumptionTypePayload, AddContactPayload, AddCouponPayload, AddCredentialPayload, AddCreditNotePayload, AddDebitNotePayload, AddDeliveryChallanPayload, AddDiscountPayload, AddEstimatePayload, AddExpensePayload, AddInvoicePayload, AddLocationPayload, AddLoyaltyPayload, AddMaterialConsumptionPayload, AddModulePayload, AddModulePermissionPayload, AddPaymentTermsPayload, AddPosCreditNotePayload, AddPosPaymentPayload, AddPosProductOrderPayload, AddPrefixPayload, AddProductPayload, AddProductTypePayload, AddPurchaseDebitNotePayload, AddPurchaseOrderPayload, AddRecipePayload, AddReportFormatPayload, AddReturnPosOrderPayload, AddRolesPayload, AddSalaryPayload, AddSalesCreditNotePayload, AddSalesOrderPayload, AddSpecialPayload, AddStockBulkAdjustmentPayload, AddStockPayload, AddStockTransferPayload, AddStockVerificationPayload, AddSupplierBillPayload, AddTaxPayload, AddTermsConditionPayload, AddUomPayload, AddUserPayload, AnalyzeTablePayload, ApplyCouponPayload, ApproveStockTransferPayload, ChangePasswordPayload, ConfirmReceiptStockTransferPayload, DispatchStockTransferPayload, EditAdditionalChargesPayload, EditAdminSettingPayload, EditAnnouncementPayload, EditBankPayload, EditBankTransactionPayload, EditBillOfLiveProductPayload, EditBranchPayload, EditBrandPayload, EditCallRequestPayload, EditCategoryPayload, EditCompanyPayload, EditConsumptionTypePayload, EditContactPayload, EditCouponPayload, EditCredentialPayload, EditCreditNotePayload, EditDebitNotePayload, EditDeliveryChallanPayload, EditDiscountPayload, EditEstimatePayload, EditExpensePayload, EditInvoicePayload, EditLocationPayload, EditLoyaltyPayload, EditLoyaltyPointPayload, EditMaterialConsumptionPayload, EditModulePayload, EditPaymentTermsPayload, EditPermissionPayload, EditPosCreditNotePayload, EditPosPaymentPayload, EditPosProductOrderPayload, EditPrefixPayload, EditProductPayload, EditProductTypePayload, EditPurchaseDebitNotePayload, EditPurchaseOrderPayload, EditRecipePayload, EditReportFormatPayload, EditReturnPosOrderPayload, EditRolesPayload, EditSalaryPayload, EditSalesCreditNotePayload, EditSalesOrderPayload, EditSpecialPayload, EditStockTransferPayload, EditStockVerificationPayload, EditSupplierBillPayload, EditTaxPayload, EditTermsConditionPayload, EditUomPayload, EditUserPayload, LoginPayload, LoginResponse, PosCreditNoteRefundFormValues, RejectStockTransferPayload, ResendOtpPayload, UploadResponse, UserApiResponse, VerifyOtpPayload, BulkSendContactWhatsAppPayload, BulkSendWhatsAppResponse, CreateMetaTemplatePayload, MetaTemplateApiResponse, MetaWhatsAppAccountApiResponse, UpsertMetaWhatsAppAccountPayload } from "../Types";
...
export const Mutations = {
  ...
  //*************** Specials **************** */
  useAddSpecial: () => useMutations<AddSpecialPayload, void>([KEYS.SPECIALS.ADD, KEYS.SPECIALS.BASE], (input) => Post(URL_KEYS.SPECIALS.ADD, input)),
  useEditSpecial: () => useMutations<EditSpecialPayload, void>([KEYS.SPECIALS.EDIT, KEYS.SPECIALS.BASE], (input) => Put(URL_KEYS.SPECIALS.EDIT, input)),
  useDeleteSpecial: () => useMutations<string, void>([KEYS.SPECIALS.DELETE, KEYS.SPECIALS.BASE], (id) => Delete(`${URL_KEYS.SPECIALS.DELETE}/${id}`)),
  ...
  //*************** Report Format **************** */
  useAddReportFormat: () => useMutations<AddReportFormatPayload, void>([KEYS.REPORT_FORMAT.ADD, KEYS.REPORT_FORMAT.BASE], (input) => Post(URL_KEYS.REPORT_FORMAT.ADD, input)),
  useEditReportFormat: () => useMutations<EditReportFormatPayload, void>([KEYS.REPORT_FORMAT.EDIT, KEYS.REPORT_FORMAT.BASE], (input) => Put(URL_KEYS.REPORT_FORMAT.EDIT, input)),
  useDeleteReportFormat: () => useMutations<string, void>([KEYS.REPORT_FORMAT.DELETE, KEYS.REPORT_FORMAT.BASE], (id) => Delete(`${URL_KEYS.REPORT_FORMAT.BASE}/${id}`)),
  ...
  useSendPosBillWhatsApp: () => useMutations<{ posOrderId: string; templateId?: string }, void>([KEYS.META_WHATSAPP.SEND_POS_BILL], (input) => Post(URL_KEYS.META_WHATSAPP.SEND_POS_BILL, input)),
  useBulkSendContactWhatsApp: () => useMutations<BulkSendContactWhatsAppPayload, BulkSendWhatsAppResponse>([KEYS.META_WHATSAPP.SEND_CONTACTS], (input) => Post(URL_KEYS.META_WHATSAPP.SEND_CONTACTS, input)),
};
