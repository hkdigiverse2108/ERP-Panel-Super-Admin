...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 flex bg-white dark:bg-gray-900 lg:border-b border-gray-200 dark:border-gray-800 transition-all duration-300 ${isExpanded || isHovered ? "lg:ml-72.5 lg:w-[calc(100%-290px)]" : "lg:ml-22.5 lg:w-[calc(100%-90px)]"}`}>
