  ...
  return (
    <CommonCard hideDivider grid={{ xs: 12 }}>
      <Box sx={{ p: 2, display: "flex", gap: 2, flexDirection: { xs: "column", md: "row" }, justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        <Box className="border text-sm w-full md:w-1/3" sx={{ borderRadius: "8px", overflow: "hidden" }}>
          {/* Row 1: Flat Discount */}
          ...
          <Box className="grid grid-cols-[150px_1fr] border-b">
            ...
            <Box className="p-1 px-2 flex justify-end">
              <CommonValidationTextField name="roundOff" label="" type="number" size="small" sx={{ width: "50%", "& input": { textAlign: "right" } }} />
            </Box>
          </Box>
