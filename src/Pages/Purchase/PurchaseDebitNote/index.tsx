...
import {
    AdvancedSearch,
    CalculateGridSummary,
    CommonActionColumn,
    CommonBreadcrumbs,
    CommonCard,
    CommonDataGrid,
    CommonDataGridSummaryFooter,
    CommonDeleteModal,
    CommonStatsCard
...
const PurchaseDebitNoteIndex = () => {
    ...
    const allRows = useMemo(() => purchaseDebitNote?.data?.purchaseDebitNote_data?.map((item) => ({
        ...item,
        id: item._id,
    ...
    return (
        <>
            ...
            <Box sx={{ p: { xs: 2, md: 3 }, display: "grid", gap: 2 }}>
                ...
                <CommonCard title="Purchase Debit Notes" hideDivider>
