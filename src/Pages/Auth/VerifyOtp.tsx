        ...
        <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto mt-10 lg:mt-0 gap-10">
          <div>
            <div className="mb-4 sm:mb-5">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Enter your otp to sign in!</p>
            </div>
            <Formik initialValues={{ otp: "" }} onSubmit={handleSubmit}>
              <Form>
                <Grid container spacing={2}>
                  <CommonValidationTextField name="otp" label="OTP" placeholder="Enter your OTP" required isFormLabel grid={{ xs: 12 }} />
                  <CommonButton loading={false} type="submit" variant="contained" title="Verify OTP" size="medium" fullWidth grid={{ xs: 12 }} />
                </Grid>
              </Form>
            </Formik>
          </div>
