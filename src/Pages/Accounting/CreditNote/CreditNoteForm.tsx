              ...
              <Grid container spacing={2}>
                <CommonCard hideDivider grid={{ xs: 12 }}>
                  <Grid container spacing={2} sx={{ p: 2 }}>
                    ...
                    <DependentSelect name="bankAccountId" label="Bank Account" query={Queries.useGetBankDropdown} params={{ companyFilter: values.companyId, branchFilter: values.branchId }} enabled={Boolean(values.companyId && values.branchId)} disabled={!values.companyId || !values.branchId} required grid={{ xs: 12, md: 4 }} />
