            ...
            <Form noValidate>
              <Grid container spacing={2}>
                ...
                <CommonCard title="Final Products">
                  <Box p={2} display="flex" flexWrap="wrap" gap={2}>
                    <DependentSelect name="finalProducts.productId" label="Product" query={Queries.useGetBankDropdown} params={{ companyFilter: values.companyId }} enabled={Boolean(values.companyId)} disabled={!values.companyId} required grid={{ xs: 12, md: 4 }} />
